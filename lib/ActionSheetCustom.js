...
class ActionSheet extends React.Component {
  ...
  _getMarginTopValue() {
    const testValue = this.props.options.length - 1;
    return testValue <= 1 ? 0 : testValue;
  }
  ...
  _createButton(title, index) {
    ...
    const buttonBoxStyle =
      cancelButtonIndex === index
        ...
        : {
            height: 50 + this._getMarginTopValue(),
            marginTop: hairlineWidth,
            alignItems: "center",
            justifyContent: "center",
            alignSelf: "center",
            backgroundColor: "rgba(223,223,223,1)",
            borderTopRightRadius: index === 1 ? 14 : undefined,
            borderTopLeftRadius: index === 1 ? 14 : undefined,
            borderBottomRightRadius:
              index === options.length - 1 ? 14 : undefined,
